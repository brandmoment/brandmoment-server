...
func TestCreativeService_Create(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			req:           CreateCreativeRequest{Name: "Banner 320x50", Type: "html5", FileURL: "https://cdn.example.com/file.zip", FileSizeBytes: &fileSize},
		...
		},
		{
			...
			req:           CreateCreativeRequest{Name: "Banner", Type: "html5", FileURL: "https://cdn.example.com/file.zip"},
		...
		{
			name:          "empty name",
			req:           CreateCreativeRequest{Name: "", Type: "html5", FileURL: "https://cdn.example.com/file.zip"},
			campaignGetFn: campaignFound,
			wantErr:       true,
		...
		{
			name:          "name too long",
			req:           CreateCreativeRequest{Name: strings.Repeat("a", 201), Type: "html5", FileURL: "https://cdn.example.com/file.zip"},
			campaignGetFn: campaignFound,
			wantErr:       true,
			wantErrIs:     model.ErrInvalidInput,
		},
		{
			name:          "invalid type",
			req:           CreateCreativeRequest{Name: "Banner", Type: "gif", FileURL: "https://cdn.example.com/file.zip"},
			campaignGetFn: campaignFound,
			wantErr:       true,
			wantErrIs:     model.ErrInvalidInput,
		},
		{
			name:          "empty file_url",
			req:           CreateCreativeRequest{Name: "Banner", Type: "html5", FileURL: ""},
			campaignGetFn: campaignFound,
			wantErr:       true,
			wantErrIs:     model.ErrInvalidInput,
		},
		{
			name:          "invalid file_url scheme s3",
		...
		{
			name:          "invalid file_url not a url",
			req:           CreateCreativeRequest{Name: "Banner", Type: "html5", FileURL: "not-a-url"},
			campaignGetFn: campaignFound,
			wantErr:       true,
			wantErrIs:     model.ErrInvalidInput,
		},
		{
			...
			req:           CreateCreativeRequest{Name: "Banner", Type: "image", FileURL: "https://cdn.example.com/file.zip", FileSizeBytes: &negFileSize},
			campaignGetFn: campaignFound,
			wantErr:       true,
			wantErrIs:     model.ErrInvalidInput,
		},
		{
			...
			req:           CreateCreativeRequest{Name: "Banner", Type: "image", FileURL: "https://cdn.example.com/file.zip", FileSizeBytes: &zeroFileSize},
			campaignGetFn: campaignFound,
			wantErr:       true,
			wantErrIs:     model.ErrInvalidInput,
		},
...
func TestCreativeService_Update(t *testing.T) {
	...
	existingCreative := &model.Creative{
		...
		FileURL:    "https://cdn.example.com/old.zip",
		IsActive:   true,
		CreatedAt:  time.Now(),
		UpdatedAt:  time.Now(),
	}
	...
	tests := []struct {
		...
		{
			name:     "success",
			req:      UpdateCreativeRequest{Name: "Updated Banner", Type: "html5", FileURL: "https://cdn.example.com/new.zip", IsActive: true},
		...
		{
			name:      "empty name",
			req:       UpdateCreativeRequest{Name: "", Type: "html5", FileURL: "https://cdn.example.com/new.zip"},
			updateFn:  successUpdateFn,
			wantErr:   true,
			wantErrIs: model.ErrInvalidInput,
		},
		{
			name:      "name too long",
			req:       UpdateCreativeRequest{Name: strings.Repeat("x", 201), Type: "html5", FileURL: "https://cdn.example.com/new.zip"},
			updateFn:  successUpdateFn,
			wantErr:   true,
			wantErrIs: model.ErrInvalidInput,
		},
		{
			name:      "invalid type",
			req:       UpdateCreativeRequest{Name: "Banner", Type: "gif", FileURL: "https://cdn.example.com/new.zip"},
			updateFn:  successUpdateFn,
			wantErr:   true,
			wantErrIs: model.ErrInvalidInput,
		},
		{
			name:      "empty file_url",
			req:       UpdateCreativeRequest{Name: "Banner", Type: "html5", FileURL: ""},
			updateFn:  successUpdateFn,
			wantErr:   true,
			wantErrIs: model.ErrInvalidInput,
		},
		{
			name:      "invalid file_url scheme s3",
			req:       UpdateCreativeRequest{Name: "Banner", Type: "html5", FileURL: "s3://bucket/new.zip"},
			updateFn:  successUpdateFn,
			wantErr:   true,
			wantErrIs: model.ErrInvalidInput,
		},
		{
			...
			req:       UpdateCreativeRequest{Name: "Banner", Type: "image", FileURL: "https://cdn.example.com/new.zip"},
		...
		},
		{
			...
			req:      UpdateCreativeRequest{Name: "Banner", Type: "video", FileURL: "https://cdn.example.com/new.mp4"},
